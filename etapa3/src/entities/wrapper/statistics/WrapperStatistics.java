...
//        array.forEach(kIntegerEntry -> answer
//                        .put(func.apply(kIntegerEntry.getKey()),
//                                kIntegerEntry.getValue()));

        for (Entry<K, Integer> kIntegerEntry: array) {
            answer.put(func.apply(kIntegerEntry.getKey()), kIntegerEntry.getValue());
        }


        return answer;
//        return new LinkedHashMap<>(array.stream().limit(LIMIT)
//                .collect(Collectors.toMap(
//                        kIntegerEntry -> func.apply(kIntegerEntry.getKey()),
//                        Entry::getValue
//                )));
    }
